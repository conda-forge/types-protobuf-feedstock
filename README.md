About types-protobuf-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-protobuf-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-protobuf-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-protobuf
# for installing globally
pixi global install types-protobuf
```
...
It is possible to list all of the versions of `types-protobuf` available on your platform:
...
```
pixi search types-protobuf --channel conda-forge
```
